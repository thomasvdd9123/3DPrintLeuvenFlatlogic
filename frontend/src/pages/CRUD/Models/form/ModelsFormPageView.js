...
import ModelsFormView from 'pages/CRUD/Models/form/ModelsFormView';
import { push } from 'connected-react-router';
import actions from 'actions/models/modelsFormActions';
import { connect } from 'react-redux';

const ModelsFormPageView = (props) => {
...
export default connect(mapStateToProps)(ModelsFormPageView);
