...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/models/autocomplete`, { params });
  return response.data;
}

const ModelsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.models.hasPermissionToCreate,
});

export default connect(select)(ModelsSelectItem);
