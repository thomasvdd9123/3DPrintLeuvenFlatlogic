...
import actionsOrders from 'actions/orders/ordersFormActions';
...
const OrdersTable = () => {
  ...
  const update = (id, data) => {
    dispatch(actionsOrders.doUpdate(id, data));
  };
  ...
  return (
    <div>
      <Widget title={humanize('Orders')} disableWidgetMenu>
        <Box className={classes.actions}>
          <Link to='/admin/orders/new' className={classes.element}>
